...
|Navegador|[Chrome](https://play.google.com/store/apps/details?id=com.android.chrome), [Firefox](https://play.google.com/store/apps/details?id=org.mozilla.firefox) (possui algumas bibliotecas do Chromecast)|[Fennec F-Droid](https://f-droid.org/en/packages/org.mozilla.fennec_fdroid/) (Fork do Firefox), [Mull](https://f-droid.org/packages/us.spotco.fennec_dos/) (Outro fork do Firefox) , [Tor Browser para Android](https://www.torproject.org/download/#android), [Bromite](https://www.bromite.org/) (Fork do Chromium, com bloqueador de propaganda funcionando relativamente bem)|
